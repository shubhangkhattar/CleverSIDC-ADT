...
public class Test2Case2 {
	public static void main(String[] args) {
		...
		try {
			System.out.println("Reading dataset 2...");
			sc = new Scanner(new FileReader("./Test_Files/Test2_dataset_less than_10^5"));
		} catch (FileNotFoundException e) {
			System.out.println(e.getMessage());
		}

		CleverSIDC cleverSIDC = new CleverSIDC(2000);
		...
		System.out.println("Prev key of 01317208: " + cleverSIDC.prevKey("01317208"));
		
		System.out.println("==========");
		System.out.println("nextKey(CleverSIDC,key): return the key for the successor of key;");
		System.out.println("Next key of 01317208: " + cleverSIDC.nextKey("01317208"));
		...
		System.out.println("Number of keys between 01091016 & 02086778: " + cleverSIDC.rangeKey("01091016","02086778"));
