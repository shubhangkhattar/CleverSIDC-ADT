...
public class Test7Case3BenchMarkFile2 {
	public static void main(String[] args) {
		...
		try {
			System.out.println("Reading Benchmark File2...");
			sc = new Scanner(new FileReader("./NASTA_test_files/NASTA_test_file2.txt"));
		...
		System.out.println("Prev key of 00002456: " + cleverSIDC.prevKey("00002456"));
		
		System.out.println("==========");
		System.out.println("nextKey(CleverSIDC,key): return the key for the successor of key;");
		System.out.println("Next key of 00002456: " + cleverSIDC.nextKey("00002456"));
