...
public class Test8Case3BenchMarkFile3 {
	public static void main(String[] args) {
		...
		try {
			System.out.println("Reading Benchmark File3...");
			sc = new Scanner(new FileReader("./NASTA_test_files/NASTA_test_file3.txt"));
		} catch (FileNotFoundException e) {
			System.out.println(e.getMessage());
		}

		CleverSIDC cleverSIDC = new CleverSIDC(1000000);
		...
		String value = cleverSIDC.getValues("00000726");
		System.out.println("Value of 00000726: " + value);
		
		System.out.println("==========");
		System.out.println("remove(CleverSIDC,key): remove the entry for the given key.");
		boolean isRemoved = cleverSIDC.remove("00000726");
		System.out.println("Removing key 00000726: " + isRemoved);
		value = cleverSIDC.getValues("00000726");
		System.out.println("Value of 00000726: " + value);
		...
		System.out.println("Prev key of 00002015: " + cleverSIDC.prevKey("00002015"));
		
		System.out.println("==========");
		System.out.println("nextKey(CleverSIDC,key): return the key for the successor of key;");
		System.out.println("Next key of 00002015: " + cleverSIDC.nextKey("00002015"));
