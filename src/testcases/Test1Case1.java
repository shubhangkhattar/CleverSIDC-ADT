...
public class Test1Case1 {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("Reading dataset 1...");
			sc = new Scanner(new FileReader("./Test_Files/Test1_dataset_less_than_10^3"));
		} catch (FileNotFoundException e) {
			System.out.println(e.getMessage());
		}

		CleverSIDC cleverSIDC = new CleverSIDC(40);
		...
		String value = cleverSIDC.getValues("05443833");
		System.out.println("Value of 05443833: " + value);
		
		System.out.println("==========");
		System.out.println("remove(CleverSIDC,key): remove the entry for the given key.");
		boolean isRemoved = cleverSIDC.remove("02150574");
		System.out.println("Removing key 02150574: " + isRemoved);
		value = cleverSIDC.getValues("02150574");
		System.out.println("Value of 02150574: " + value);
		...
		System.out.println("Prev key of 15452612: " + cleverSIDC.prevKey("15452612"));
		
		System.out.println("==========");
		System.out.println("nextKey(CleverSIDC,key): return the key for the successor of key;");
		System.out.println("Next key of 15452612: " + cleverSIDC.nextKey("15452612"));
		...
		System.out.println("Number of keys between 11447478 & 17728871: " + cleverSIDC.rangeKey("11447478","17728871"));
